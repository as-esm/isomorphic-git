...
import { parseRefsAdResponse } from '../../src/wire/parseRefsAdResponse.ts'
...
test('parseRefsAdResponse', async (t) => {
  await t.test('parse protocol v1 - basic response with one ref', async () => {
  ...
  await t.test('parse protocol v1 - multiple refs', async () => {
    // Setup: Multiple refs
    const service = 'git-upload-pack'
    const response = [
      GitPktLine.encode(`# service=${service}`),
  ...
  await t.test('parse protocol v1 - empty repo (zero refs)', async () => {
  ...
  await t.test('parse protocol v1 - with symrefs', async () => {
  ...
  await t.test('parse protocol v1 - no-refs capability (git 2.41.0+)', async () => {
  ...
  await t.test('parse protocol v1 - skip flush packets', async () => {
  ...
  await t.test('parse protocol v1 - service line with trailing LF', async () => {
  ...
  await t.test('parse protocol v1 - multiple symrefs', async () => {
  ...
  await t.test('parse protocol v1 - empty capabilities', async () => {
  ...
  await t.test('parse protocol v1 - invalid service line throws error', async () => {
  ...
  await t.test('parse protocol v1 - empty server response throws error', async () => {
  ...
  await t.test('parse protocol v2 - detected in first line', async () => {
  ...
  await t.test('parse protocol v2 - detected in second line', async () => {
  ...
  await t.test('parse protocol v1 - capabilities with empty strings filtered', async () => {

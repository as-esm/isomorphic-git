...
test('parseReceivePackResponse', async (t) => {
  await t.test('parse successful push response - unpack ok', async () => {
  ...
  await t.test('parse successful push response - multiple refs', async () => {
  ...
  await t.test('parse failed unpack response', async () => {
  ...
  await t.test('parse ref rejection - ng status', async () => {
  ...
  await t.test('parse mixed success and failure', async () => {
  ...
  await t.test('parse response with error message in ref', async () => {
  ...
  await t.test('parse response with empty error message', async () => {
  ...
  await t.test('parse response with empty lines', async () => {
  ...
  await t.test('parse response without unpack line throws error', async () => {
  ...
  await t.test('parse response with invalid unpack line throws error', async () => {
  ...
  await t.test('parse response with long error message', async () => {
  ...
  await t.test('parse response with ref name containing spaces', async () => {

...
import { getIterator } from '../../src/utils/getIterator.ts'

test('getIterator', async (t) => {
  await t.test('returns async iterator from async iterable', async () => {
    async function* gen() {
      yield 1
      yield 2
      yield 3
  ...
  await t.test('returns async iterator from sync iterable', async () => {
    const arr = [1, 2, 3]
  ...
  await t.test('returns iterator with next method', async () => {
    const iterator = {
      next() {
  ...
  await t.test('converts single value to iterator', async () => {
  ...
  await t.test('handles string as iterable', async () => {
  ...
  await t.test('handles Set as iterable', async () => {
  ...
  await t.test('handles Map as iterable', async () => {

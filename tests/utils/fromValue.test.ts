...
test('fromValue', async (t) => {
  await t.test('converts value to async iterator', async () => {
  ...
  await t.test('next returns the value', async () => {
  ...
  await t.test('next returns done after first call', async () => {
  ...
  await t.test('return method clears queue', async () => {
    const iterator = fromValue('test')
  ...
  await t.test('is iterable with for await', async () => {

...
import { emptyPackfile } from '../../src/utils/emptyPackfile.ts'

test('emptyPackfile', async (t) => {
  await t.test('returns true for empty packfile', () => {
  ...
  await t.test('returns false for packfile with objects', () => {
  ...
  await t.test('returns false for invalid packfile header', () => {
  ...
  await t.test('returns false for wrong version', () => {
  ...
  await t.test('handles very small buffer', () => {

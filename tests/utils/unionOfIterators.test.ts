...
import { unionOfIterators } from '../../src/utils/unionOfIterators.ts'

test('unionOfIterators', async (t) => {
  await t.test('unions two iterators with common values', () => {
  ...
  await t.test('unions three iterators', () => {
  ...
  await t.test('handles empty iterators', () => {
  ...
  await t.test('handles all empty iterators', () => {
    const set1 = [][Symbol.iterator]()
  ...
  await t.test('handles single iterator', () => {
  ...
  await t.test('handles iterators with no common values', () => {
  ...
  await t.test('handles identical iterators', () => {
    const set1 = ['a', 'b', 'c'][Symbol.iterator]()
  ...
  await t.test('handles iterators of different lengths', () => {

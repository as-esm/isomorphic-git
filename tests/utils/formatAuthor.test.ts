...
import { formatAuthor } from '../../src/utils/formatAuthor.ts'
import type { Author } from '../../src/models/GitCommit.ts'

test('formatAuthor', async (t) => {
  await t.test('formats author with positive timezone offset', () => {
    const author: Author = {
      name: 'Test User',
  ...
  await t.test('formats author with negative timezone offset', () => {
    const author: Author = {
      name: 'Test User',
      email: 'test@example.com',
      timestamp: 1234567890,
  ...
  await t.test('formats author with zero timezone offset', () => {
    const author: Author = {
      name: 'Test User',
      email: 'test@example.com',
      timestamp: 1234567890,
  ...
  await t.test('formats author with negative zero timezone offset', () => {
    const author: Author = {
      name: 'Test User',
      email: 'test@example.com',
      timestamp: 1234567890,
  ...
  await t.test('formats author with single-digit hours and minutes', () => {
    const author: Author = {
      name: 'Test User',
      email: 'test@example.com',
      timestamp: 1234567890,
  ...
  await t.test('formats author with large timezone offset', () => {
    const author: Author = {
      name: 'Test User',
      email: 'test@example.com',
      timestamp: 1234567890,
  ...
  await t.test('formats author with name containing special characters', () => {
    const author: Author = {
      name: 'Test <User>',
      email: 'test@example.com',
      timestamp: 1234567890,
  ...
  await t.test('formats author with email containing special characters', () => {
    const author: Author = {
      name: 'Test User',

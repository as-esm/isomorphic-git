...
test('clone from file system', async (t) => {
  await t.test('clone basic repository', async () => {
  ...
  await t.test('clone specific branch', async () => {
    Repository.clearInstanceCache()
  ...
  await t.test('clone repository with multiple commits and verify history', async () => {
    Repository.clearInstanceCache()
  ...
  await t.test('clone repository with tags and branches', async () => {
    Repository.clearInstanceCache()
  ...
  await t.test('clone repository and verify objects are copied', async () => {
    Repository.clearInstanceCache()

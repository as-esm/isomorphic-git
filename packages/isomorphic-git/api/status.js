 ...
 *
 */
export async function status({ fs: _fs, dir, gitdir = join(dir, '.git'), filepath, cache = {}, }) {
    try {
        ...
        const indexEntry = await GitIndexManager.acquire({ fs, gitdir, cache }, async function (index) {

// @ts-check
import { _stashPush, _stashApply, _stashDrop, _stashList, _stashClear, _stashPop, _stashCreate, } from '../commands/stash.js';
 ...
 */
export async function stash({ fs, dir, gitdir = join(dir, '.git'), op = 'push', message = '', refIdx = 0, }) {

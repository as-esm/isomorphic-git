 ...
 */
export declare function _commit({ fs, cache, onSign, gitdir, message, author: _author, committer: _committer, signingKey, amend, dryRun, noUpdateBranch, ref, parent, tree, }: {
    fs: any;
    cache: any;
    onSign: any;
    gitdir: any;

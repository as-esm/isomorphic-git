...
import type { SignCallback, MessageCallback,AuthFailureCallback,AuthCallback,AuthSuccessCallback } from '../typedefs.ts'
import type { ProgressCallback, HttpClient } from '../typedefs-http.ts'
/**
 * @param {object} args
